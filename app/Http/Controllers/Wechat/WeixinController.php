...
class WeixinController extends Controller
{
     ...
     * 创建个性化菜单
     */
    public function set_wx_group_menu_a()
    {
        $groupId = Input::get("groupId");
     ...
     * 创建个性化菜单
     */
    public function set_wx_group_menu_b()
    {   
        $groupId = Input::get("groupId");
     ...
     * 测试用户分组菜单
     */
    public function get_wx_user_mennu()
    {
