            ...
            <el-row>
                <el-col :span="24">
                    <div class="wechat-title">
                        ...
                        <p>5、微信模板消息所在行业必须设置为IT科技/互联网|电子商务、IT科技/IT软件与服务。 </p>
                    </div>
                    ...
                    <el-form label-width="300px">
                        <el-form-item v-for="item in items" :label="getName(item)">
...
<script>
    export default{
        ...
        methods: {
            ...
            getData(){
                this.loading = true;
                this.$http.post("/weixin/template/get").then(function (response) {
            ...
            setIndustry() {
                this.loading = true;
                this.$http.post("/weixin/industry").then(function (response) {
                    this.loading = false;
                });
            },
            autoUpdate() {
                this.loading = true;
                this.$http.post("/weixin/auto_update").then(function (response) {
                    this.loading = false;
            ...
            singleUpdate(vo) {
                this.loading = true;
                this.$http.post("/weixin/update", {tpl_key: vo.template_key, tpl_id: vo.template_id}).then(function (response) {
                    this.loading = false;
            ...
            manualUpdate(vo) {
                this.loading = true;
                this.$http.post("/weixin/template/set", {tpl_key: vo.template_key, tpl_id: vo.template_id}).then(function (response) {
                    this.loading = false;
                });
            },
        },
